# Mapping Human Hematopoietic Stem Cell Ontogeny from Hemogenic Endothelium to Birth
...
There are many dotplots in the manuscript serving as scorecards to define cell identities. To make it earsier to reproduce these cell types, the R script file containing the gene lists and codes to make the dotplots can be accessed [here.](). The first four lines in the script describes how the dotplots can be plotted.
